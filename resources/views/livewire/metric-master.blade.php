<div class="max-w-7xl">
    ...
    <div class="flex justify-around px-8 py-4 gap-4">
        <a
            href="#"
            class="relative w-full block rounded-sm border-t-4 border-pink-600 p-4 shadow-xl sm:p-6 lg:p-8"
        >
        ...
        <a
            href="#"
            class="relative w-full block rounded-sm border-t-4 border-yellow-600 p-4 shadow-xl sm:p-6 lg:p-8"
        >
            <div class="flex items-center gap-4">
                <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <a
            href="#"
            class="relative w-full block rounded-sm border-t-4 border-purple-600 p-4 shadow-xl sm:p-6 lg:p-8"
        >
            <div class="flex items-center gap-4">
                <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <a
            href="#"
            class="relative w-full block rounded-sm border-t-4 border-orange-600 p-4 shadow-xl sm:p-6 lg:p-8"
        >
            <div class="flex items-center gap-4">
